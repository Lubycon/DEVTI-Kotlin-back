...
('VF', '', 'UI/UX 개발의 수호자✨', '어울리는 폰트와 아이콘을 선택하는 것에도 진심이죠.'),
('VF', '', 'UI/UX 개발의 수호자✨', '못생긴 건.. 만들기 싫어요 🥲'),

('VB', '', '균형감각 최고! 만능 개발자 ⚖️', '내부 로직을 꼼꼼히 보는 백엔드 개발자가 시각화에도 강점을 갖고 있다니 보기 드문 인재신데요!?'),
('VB', '', '균형감각 최고! 만능 개발자 ⚖️', '아무리 완벽한 로직도 유저에게 의미있는 결과물이 되어야 한다는 걸 알고 있어요.'),
...
('S1', '', '작은 규모의 스타트업 🚀', '예측하지 못한 상황이 생겨도 발빠르게 대처하는 편이에요.'),

('S2', '', '중견 스타트업 🔧', '갓 창업한 스타트업보다는 조금씩 체계를 갖추며 성장해나가는 50~200명 규모의 스타트업이 어울려요.'),
('S2', '', '중견 스타트업 🔧', '혼자보다는 동료들과 함께할 때 시너지가 나요.'),
('S2', '', '중견 스타트업 🔧', '자유로운 문화 만큼이나 적절한 규칙을 만들어나가는 것도 중요하게 생각해요.'),
...
('C2', '', 'IT 대기업 🏙', '내 업무에 집중하는 시간을 확보해야 생산성이 높아지는 편이에요.'),
...
('P', '', '제품이 우선! 🙉', '동료의 고민은 곧 내 고민과 다름없어요. 언제나 주변을 살펴요. 🕊'),
...
('T', '', '개발 장인 🛠', '재미있는 기술이 보이면 바로 써보고 싶어요.'),

('L', '', '라이프 중시 성향🏄', '일 할 땐 일 하고 쉴 땐 후회없이 푹 쉬는 게 최고! 쉴 때는 업무 관련된 생각을 최대한 OFF해요.'),
('L', '', '라이프 중시 성향🏄', '오늘 회사에서 있었던 일은 퇴근하는 순간 싹 잊어버려요.'),
('L', '', '라이프 중시 성향🏄', '취미는 일과 굳이 관련이 없는 게 좋아요.'),
('L', '', '라이프 중시 성향🏄', '일은 인생의 목표를 향해 가는 과정 중 하나일 뿐! 🏄‍♀️'),

('W', '', '커리어 중시 성향 🏃', '일을 사랑하는 당신, 커리어에서 이루고 싶은 명확한 골이 있기에 매사 최선을 다하고 싶어요.️'),
('W', '', '커리어 중시 성향 🏃', '목표한 일이 있다면 다 끝내고 가야 마음이 편해요.'),
('W', '', '커리어 중시 성향 🏃', '영혼없이 일하는 게 더 어려워요.'),
