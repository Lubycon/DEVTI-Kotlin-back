...
(now(), now(), 7, 1, '그렇지 않다.', 'A', 0.5),
(now(), now(), 7, 2, '보통이다', 'V', 0),
(now(), now(), 7, 3, '그렇다', 'V', 0.5),
(now(), now(), 7, 4, '매우 그렇다', 'V', 1),
...
(now(), now(), 30, 1, '그렇지 않다.', 'L', 0.5),
(now(), now(), 30, 2, '보통이다', 'W', 0),
(now(), now(), 30, 3, '그렇다', 'W', 0.5),
(now(), now(), 30, 4, '매우 그렇다', 'W', 1),

(now(), now(), 31, 0, '전혀 그렇지 않다', 'L', 1),
(now(), now(), 31, 1, '그렇지 않다.', 'L', 0.5),
(now(), now(), 31, 2, '보통이다', 'L', 0),
(now(), now(), 31, 3, '그렇다', 'W', 0.5),
(now(), now(), 31, 4, '매우 그렇다', 'W', 1),

(now(), now(), 32, 0, '전혀 그렇지 않다', 'L', 1),
(now(), now(), 32, 1, '그렇지 않다.', 'L', 0.5),
(now(), now(), 32, 2, '보통이다', 'W', 0),
(now(), now(), 32, 3, '그렇다', 'W', 0.5),
(now(), now(), 32, 4, '매우 그렇다', 'W', 1),
