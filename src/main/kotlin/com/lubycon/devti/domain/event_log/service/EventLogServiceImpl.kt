...
class EventLogServiceImpl(
    ...
    override fun createEventLog(eventLogPostReqDto: EventLogPostReqDto): EventLogPostResDto {
    ...
    override fun findCountByEventType(eventType: EventType) = eventLogRepository.countAllByEventType(eventType)
}